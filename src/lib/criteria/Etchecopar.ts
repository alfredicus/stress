...
import { angularDifStriations, faultStressComponents } from "../utils"
...
export class Etchecopar extends MisfitCriteriun {
    ...
    value(stressTensorDelta: Matrix3x3): number {
        ...
        for (let i = 0; i < this.faultSet.length; i++) {
            ...
            // 
            angularDifStriae[i] = angularDifStriations({e_striation: fault.e_striation, shearStress, shearStressMag})
        }
