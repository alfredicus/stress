// Calculation and plot of the fault data in the Mohr Cicle diagram.

import { fault } from "./utils"

// Each fault is characterized by a normal vector pointing upward
// fault.normal[0],fault.normal[1],fault.normal[2]
// Calculate the normal vector in reference frame S': fault.normalSp[0],fault.normalSp[1],fault.normalSp[2]
